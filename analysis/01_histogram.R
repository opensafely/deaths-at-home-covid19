...
plot_age <- ggplot(data=df_input, aes(df_input$age_death)) + 
  ...
  theme(
    ...
    axis.title.x = element_text(margin = margin(t = 0, r = 0, b = 0, l = 0, unit = "cm"), colour = "#271544", size = 8, face = "bold"),
    axis.title.y = element_text(margin = margin(t = 0, r = 0, b = 0, l = 0, unit = "cm"), colour = "#271544", size = 8, face = "bold", angle = 90),
